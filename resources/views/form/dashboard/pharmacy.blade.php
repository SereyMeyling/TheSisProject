...
<div class="container-fluid pt-3">
    ...
    <div class="card bg-gradient-success text-white mb-4 shadow-sm"
        style="border-radius: 16px; background: linear-gradient(135deg, #11998e, #38ef7d);">
        <div class="card-body p-4 d-flex align-items-center justify-content-between">
            <div>
                <h2 class="font-weight-bold mb-1"><i class="fas fa-pills mr-2"></i>ផ្ទាំងគ្រប់គ្រងឱសថស្ថាន (Pharmacy
                    Dashboard)</h2>
                <p class="mb-0 text-white-50">ការគ្រប់គ្រងស្តុកថ្នាំ ថ្នាំជិតផុតកំណត់ ការលក់ និងវេជ្ជបញ្ជា។</p>
            </div>
            <div>

                <a href="{{ route('pharmacy.index') }}" class="btn btn-outline-light font-weight-bold px-3 py-2"
            ...
            <div class="card h-100 shadow-sm border-0" style="border-radius: 16px;">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="h3 font-weight-bold mb-0 text-danger">
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow-sm border-0 mb-4" style="border-radius: 16px;">
                <div class="card-header bg-white border-0 pt-4 px-4 d-flex align-items-center justify-content-between">
                    <h5 class="font-weight-bold mb-0 text-danger"><i
                            class="fas fa-exclamation-circle mr-2"></i>ថ្នាំជិតផុតកំណត់ (Expiring Soon - 30 Days)</h5>
            ...
            <div class="card shadow-sm border-0 h-100" style="border-radius: 16px;">
                <div class="card-header bg-white border-0 pt-4 px-4 d-flex align-items-center justify-content-between">
                    <h5 class="font-weight-bold mb-0 text-dark"><i
                            class="fas fa-prescription-bottle-alt text-info mr-2"></i>បញ្ជីវេជ្ជបញ្ជាចុងក្រោយ
                        (Prescriptions)</h5>
                        ...
                        <tbody>
                            @forelse($pendingPrescriptions as $pres)
                                <tr>
                                    ...
                                    <td>{{ $pres->medicalRecord->patient->full_name ?? 'N/A' }}</td>
                                    <td class="small text-muted">{{ optional($pres->prescribed_date)->format('Y-m-d') }}
                                    </td>
                                    <td class="text-right pr-4">
                                        <a href="{{ route('pharmacy.prescriptions.index') }}"
                                            class="btn btn-sm btn-outline-success" style="border-radius: 12px;">
