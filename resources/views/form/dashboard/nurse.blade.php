...
<div class="container-fluid pt-3">
    {{-- Header Banner --}}
    <div class="card bg-gradient-danger text-white mb-4 shadow-sm" style="border-radius: 16px; background: linear-gradient(135deg, #e52d27, #b31217);">
        <div class="card-body p-4 d-flex align-items-center justify-content-between">
            <div>
                <h2 class="font-weight-bold mb-1"><i class="fas fa-user-nurse mr-2"></i>ផ្ទាំងគ្រប់គ្រងគិលានុបដ្ឋាយិកា (Nurse Dashboard)</h2>
                <p class="mb-0 text-white-50">ការគ្រប់គ្រងបន្ទប់សម្រាកព្យាបាល ការចូលសម្រាកព្យាបាល (Admissions) និងការថែទាំអ្នកជំងឺ។</p>
            </div>
            <a href="{{ route('patients.create') }}" class="btn btn-light font-weight-bold px-4 py-2 text-danger" style="border-radius: 20px;">
                <i class="fas fa-user-plus mr-1"></i> ចុះឈ្មោះអ្នកជំងឺ
            </a>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-7 mb-4">
            <div class="card shadow-sm border-0 h-100" style="border-radius: 16px;">
                <div class="card-header bg-white border-0 pt-4 px-4 d-flex align-items-center justify-content-between">
                    <h5 class="font-weight-bold mb-0 text-dark"><i class="fas fa-procedures text-danger mr-2"></i>បញ្ជីអ្នកជំងឺកំពុងសម្រាកព្យាបាល (Active Inpatients)</h5>
                </div>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge badge-danger px-2 py-1"><i class="fas fa-door-closed"></i> {{ $adm->room->room_number ?? 'Room' }}</span>
                                </td>
                                <td class="small text-muted">{{ optional($adm->admission_date)->format('Y-m-d H:i') }}</td>
                                <td>
                            ...
                            @empty
                            <tr>
                                <td colspan="4" class="text-center text-muted py-4">គ្មានអ្នកជំងឺកំពុងសម្រាកព្យាបាលទេ</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
        ...
        <div class="col-lg-5 mb-4">
            <div class="card shadow-sm border-0 h-100" style="border-radius: 16px;">
                <div class="card-header bg-white border-0 pt-4 px-4 d-flex align-items-center justify-content-between">
                    <h5 class="font-weight-bold mb-0 text-dark"><i class="fas fa-user-plus text-primary mr-2"></i>អ្នកជំងឺចុះឈ្មោះថ្មីៗ (Recent Patients)</h5>
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item px-4 py-3 d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <div class="small text-muted">{{ $pat->phone ?? 'No phone' }} | Gender: {{ ucfirst($pat->gender ?? 'N/A') }}</div>
                            </div>
                            <a href="{{ route('patients.show', $pat->patient_id) }}" class="btn btn-sm btn-light text-primary"><i class="fas fa-eye"></i></a>
                        </li>
                        @empty
