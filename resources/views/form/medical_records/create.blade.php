        ...
        <div class="card border-0 shadow-sm rounded-lg">
            <div class="card-body bg-light p-4">
                ...
                <div class="bg-white p-3 rounded shadow-sm mb-4">
                    <h6 class="font-weight-bold text-success mb-3"><i class="fas fa-heartbeat text-danger mr-2"></i>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <input type="number" step="0.1" name="spo2" class="form-control" placeholder="98"
                                value="{{ old('spo2') }}">
                        </div>
                        <div class="col-md-4 form-group">
                            <label class="small font-weight-bold text-secondary">Weight (kg)</label>
                            <input type="number" step="0.1" name="weight" class="form-control" placeholder="65"
                                value="{{ old('weight') }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-3 rounded shadow-sm mb-4">
                    <div class="form-group">
                        ...
                        <textarea name="diagnosis" class="form-control" rows="3"
                            placeholder="បញ្ចូលលទ្ធផលនៃការវិនិច្ឆ័យ...">{{ old('diagnosis') }}</textarea>
                    </div>
                    <div class="form-group mb-0">
                        <label class="small font-weight-bold text-secondary">ចំណាំបន្ថែម (Notes / Symptoms)</label>
                        <textarea name="notes" class="form-control" rows="2"
                            placeholder="បញ្ចូលរោគសញ្ញា ឬការកត់សម្គាល់បន្ថែម...">{{ old('notes') }}</textarea>
                    </div>
                </div>
