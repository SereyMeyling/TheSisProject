        ...
        <div class="row">
            <div class="col-lg-9">
                ...
                <div class="tab-content" id="patientTabContent">
                                        ...
                                        <tbody>
                                            @forelse($patients as $patient)
                                                <tr>
                                                    ...
                                                    <td>{{ $patient->sex == 'Male' || $patient->sex == 'male' ? 'ប្រុស' : 'ស្រី' }}</td>
                    ...
                    {{-- Tab ទី២: ទម្រង់ចុះឈ្មោះអ្នកជំងឺថ្មី (Form Store) --}}
                            ...
                            <div class="card border-0 shadow-sm rounded-lg overflow-hidden">
                                ...
                                <div class="card-body bg-light p-4">
                                    <div class="row bg-white p-3 rounded shadow-sm mb-4">
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label class="small font-weight-bold text-secondary">លេខអត្តសញ្ញាណប័ណ្ណ / ID Card</label>
...
@section('css')
    <style>
        ...
        .pagination .page-item .page-link { padding: 0.4rem 0.75rem; color: #28a745; }
        .pagination .page-item.active .page-link {
            background-color: #28a745 !important;
            border-color: #28a745 !important;
            color: #fff !important;
        }
        .pagination .page-item .page-link:hover { color: #1e7e34; }
    </style>
@stop
