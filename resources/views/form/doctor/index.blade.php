...
<div class="container-fluid py-3">
    ...
    @if($userRole === 'doctor')
        ...
        <div class="doc-top-bar d-flex flex-wrap justify-content-between align-items-center mb-4">
            <div class="d-flex align-items-center">
                <div class="bg-white text-success rounded-circle d-flex align-items-center justify-content-center mr-3 shadow-sm"
                    style="width: 50px; height: 50px; font-size: 22px;">
                    <i class="fas fa-user-md"></i>
                </div>
                <div>
                    <h5 class="font-weight-bold mb-0">{{ $doctorInfo['name'] }}</h5>
                    <small class="text-white-50"><i class="fas fa-hospital-alt mr-1"></i> {{ $doctorInfo['department'] }} |
                        ID: {{ $doctorInfo['code'] }}</small>
                </div>
            </div>

            <div class="d-flex align-items-center mt-2 mt-md-0">
                <span class="badge badge-light px-3 py-2 font-weight-bold mr-3"
            ...
            <div class="col-lg-4 mb-4">
                ...
                <div class="card-modern p-4 mb-4">
                    <div class="d-flex align-items-center mb-3">
                        <img src="https://ui-avatars.com/api/?name={{ urlencode($activeRecord->patient->full_name ?? 'Patient') }}&background=006D36&color=fff&bold=true"
                            class="avatar-circle mr-3" alt="Patient Avatar">
                        <div>
                            <h5 class="font-weight-bold text-dark mb-1">
                                {{ $activeRecord->patient->full_name ?? 'លោក ពាក់ មី' }}
                            </h5>
                            <span class="badge badge-success px-2 py-1 font-weight-bold"
                                style="border-radius: 6px;">{{ $activeRecord->patient->patient_code ?? 'ID-2001-0023' }}</span>
                        </div>
                    </div>
                    ...
                    <div class="row text-muted small">
                        ...
                        <div class="col-6 mb-2">
                            ...
                            <span
                                class="text-dark font-weight-bold">{{ ($activeRecord->patient->sex ?? '') == 'Female' ? 'ស្រី (Female)' : 'ប្រុស (Male)' }}</span>
                        </div>
                        <div class="col-6 mb-2">
                        ...
                        <div class="col-6 mb-2">
                            ...
                            <span
                                class="text-dark">{{ $activeRecord->visit_date ? $activeRecord->visit_date->format('d/m/Y H:i') : date('d/m/Y H:i') }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-modern p-4 mb-4">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h6 class="font-weight-bold text-dark mb-0"><i class="fas fa-heartbeat text-danger mr-2"></i>
                            សញ្ញាជីវិត (Vital Signs)</h6>
                        <button type="button" class="btn btn-xs btn-outline-primary font-weight-bold px-2 py-1"
                            data-toggle="modal" data-target="#vitalsModal" style="border-radius: 6px;">
                    ...
                    <div class="row">
                        <div class="col-6 mb-3">
                            <div class="vitals-box">
                                ...
                                <div class="vitals-val text-primary">{{ $activeRecord->blood_pressure ?? '120/80' }} <small
                                        class="text-muted">mmHg</small></div>
                            </div>
                        </div>
                        ...
                        <div class="col-6 mb-3">
                            <div class="vitals-box">
                                ...
                                <div class="vitals-val text-success">{{ $activeRecord->heart_rate ?? '75' }} <small
                                        class="text-muted">bpm</small></div>
                            </div>
                        </div>
                        ...
                        <div class="col-6 mb-3">
                            <div class="vitals-box">
                                ...
                                <div class="vitals-val text-danger">{{ $activeRecord->temperature ?? '38.6' }} <small
                                        class="text-muted">°C</small></div>
                            </div>
                        </div>
                        ...
                        <div class="col-6 mb-3">
                            <div class="vitals-box">
                                ...
                                <div class="vitals-val text-info">
                                    {{ $activeRecord->spo2 ?? $activeRecord->oxygen_saturation ?? '98' }} <small
                ...
                <form action="{{ route('doctor.update', $activeRecord->record_id) }}" method="POST">
                    ...
                    <div class="card-modern p-4 mb-4">
                        ...
                        <ul class="nav nav-tabs nav-tabs-custom mb-3" id="consultTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="note-tab" data-toggle="tab" href="#note" role="tab"><i
                                        class="fas fa-edit mr-1"></i> កត់ត្រាការព្យាបាល (Current Note)</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="history-tab" data-toggle="tab" href="#history" role="tab"><i
                                        class="fas fa-history mr-1"></i> ប្រវត្តិព្យាបាលចាស់ (Past History)</a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content" id="consultTabContent">
                            ...
                            <div class="tab-pane fade show active" id="note" role="tabpanel">
                                <div class="form-group mb-0">
                                    <label class="font-weight-bold text-dark">ចំណាំការព្យាបាលរបស់គ្រូពេទ្យ (Clinical
                                        Examination & Notes)</label>
                                    <textarea name="notes" class="form-control border-secondary-subtle p-3" rows="4"
                                        style="border-radius: 12px;"
                                        placeholder="បញ្ចូលចំណាំពិនិត្យ និងការព្យាបាលរបស់អ្នកជំងឺ...">{{ old('notes', $activeRecord->notes) }}</textarea>
                                </div>
                            </div>
                                    ...
                                    @forelse($historyRecords as $hist)
                                        <div class="border-left border-success pl-3 pb-3 mb-2">
                                            <div class="d-flex justify-content-between">
                                                <strong class="text-dark small"><i class="far fa-calendar-alt mr-1"></i>
                                                    {{ $hist->visit_date ? $hist->visit_date->format('d-m-Y H:i') : 'N/A' }}</strong>
                                                <span
                                                    class="badge badge-light border">{{ $hist->status_destination ?? 'done' }}</span>
                                            </div>
                                            <p class="mb-1 text-primary font-weight-bold small">រោគវិនិច្ឆ័យ:
                                                {{ $hist->diagnosis ?? 'N/A' }}
                                            </p>
                                            <p class="mb-0 text-muted small">{{ $hist->notes }}</p>
                                        </div>
                                    @empty
                                        <p class="text-muted text-center py-4 small">គ្មានប្រវត្តិព្យាបាលចាស់នៅក្នុងប្រព័ន្ធទេ។
                                        </p>
                                    @endforelse
                                </div>
                            </div>
                        ...
                        <div class="form-group mb-4">
                            <label class="font-weight-bold text-dark">រោគវិនិច្ឆ័យ (Diagnosis) <span
                            ...
                            <input type="text" id="diagnosisInput" name="diagnosis"
                                class="form-control p-3 font-weight-bold text-dark" style="border-radius: 12px;"
                ...
                <div class="modal-content border-0 rounded-lg shadow-lg">
                    <form action="{{ route('doctor.lab-order.store') }}" method="POST">
                        ...
                        <div class="modal-body p-4">
                            <p class="text-muted small mb-3">សូមជ្រើសរើសតេស្តមន្ទីរពិសោធន៍ដែលត្រូវពិនិត្យសម្រាប់អ្នកជំងឺ
                                <strong>{{ $activeRecord->patient->full_name ?? '' }}</strong>៖
                            </p>

                            <div class="list-group" style="max-height: 260px; overflow-y: auto;">
                                @forelse($labTests as $test)
                                    <label
                                        class="list-group-item d-flex justify-content-between align-items-center cursor-pointer border-radius-sm">
                                        <div>
                                ...
                                @empty
                                    <label class="list-group-item"><input type="checkbox" name="test_ids[]" value="1"
                                            class="mr-2"> CBC (Complete Blood Count)</label>
                                    <label class="list-group-item"><input type="checkbox" name="test_ids[]" value="2"
                                            class="mr-2"> Blood Sugar Test (Fasting)</label>
                                    <label class="list-group-item"><input type="checkbox" name="test_ids[]" value="3"
                                            class="mr-2"> Urine Routine & Microscopy</label>
                                    <label class="list-group-item"><input type="checkbox" name="test_ids[]" value="4"
                                            class="mr-2"> COVID-19 Rapid Antigen Test</label>
                                @endforelse
                            </div>
                        </div>
                        ...
                        <div class="modal-footer bg-light">
                            <button type="button" class="btn btn-secondary font-weight-bold"
                                data-dismiss="modal">បោះបង់</button>
                            <button type="submit" class="btn btn-primary font-weight-bold"><i
                                    class="fas fa-paper-plane mr-1"></i> បញ្ជូនទៅ Lab (Submit)</button>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="modal-content border-0 rounded-lg shadow-lg">
                    <form action="{{ route('doctor.admit.store') }}" method="POST">
                        ...
                        <div class="modal-body p-4">
                            ...
                            <div class="form-group mb-3">
                                <label class="font-weight-bold text-dark">ជ្រើសរើសបន្ទប់ទំនេរ (Available Room) <span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="modal-footer bg-light">
                            <button type="button" class="btn btn-secondary font-weight-bold"
                                data-dismiss="modal">បោះបង់</button>
                            <button type="submit" class="btn btn-success font-weight-bold"><i
                                    class="fas fa-check-circle mr-1"></i> បញ្ចូលសម្រាក (Confirm Admit)</button>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="modal-content border-0 rounded-lg shadow-lg">
                    <form action="{{ route('doctor.vitals.update') }}" method="POST">
                        ...
                        <div class="modal-header bg-danger text-white">
                            <h5 class="modal-title font-weight-bold"><i class="fas fa-heartbeat mr-2"></i>
                                ធ្វើបច្ចុប្បន្នភាពសញ្ញាជីវិត (Update Vitals)</h5>
                            <button type="button" class="close text-white"
                                data-dismiss="modal"><span>&times;</span></button>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-6 form-group">
                                    ...
                                    <input type="text" name="blood_pressure" class="form-control"
                                        value="{{ $activeRecord->blood_pressure ?? '120/80' }}" placeholder="120/80">
                                </div>
                                <div class="col-6 form-group">
                        ...
                        <div class="modal-footer bg-light">
                            <button type="button" class="btn btn-secondary font-weight-bold"
                                data-dismiss="modal">បោះបង់</button>
                            <button type="submit" class="btn btn-danger font-weight-bold"><i class="fas fa-save mr-1"></i>
                                រក្សាទុក (Save Vitals)</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    @elseif($userRole === 'admin')
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h3 class="font-weight-bold text-dark mb-1"><i class="fas fa-user-md text-success mr-2"></i> គ្រប់គ្រង
                    និងត្រួតពិនិត្យវេជ្ជបណ្ឌិត</h3>
                <small class="text-muted">បញ្ជីវេជ្ជបណ្ឌិត និងការពិនិត្យតាមដានបន្ទុកការងារ</small>
            </div>
        </div>
        ...
        <div class="row mb-4">
            <div class="col-md-4">
                <div class="card-modern p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <small class="text-muted font-weight-bold d-block">វេជ្ជបណ្ឌិតសរុប</small>
            ...
            <div class="col-md-4">
                <div class="card-modern p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <small class="text-muted font-weight-bold d-block">វេជ្ជបណ្ឌិតកំពុងសកម្ម</small>
                            <h3 class="font-weight-bold text-success mb-0">{{ $activeDoctors ?? 0 }}</h3>
                        </div>
                        <span class="bg-light text-success rounded-circle p-3"><i
            ...
            <div class="col-md-4">
                <div class="card-modern p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <small class="text-muted font-weight-bold d-block">ការពិនិត្យសរុបថ្ងៃនេះ</small>
        ...
        <div class="card-modern p-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h6 class="font-weight-bold text-dark mb-0"><i class="fas fa-list mr-1"></i>
                    បញ្ជីឈ្មោះវេជ្ជបណ្ឌិតក្នុងប្រព័ន្ធ</h6>
    ...
    @elseif($userRole === 'nurse')
        ...
        <div class="doc-top-bar d-flex flex-wrap justify-content-between align-items-center mb-4">
            <div>
                <h5 class="font-weight-bold mb-0"><i class="fas fa-user-nurse mr-2"></i>
                    {{ $nurseShift['name'] ?? 'Nurse Workspace' }}
                </h5>
                <small class="text-white-50"><i class="fas fa-clock mr-1"></i> {{ $nurseShift['shift'] }} |
                    {{ $nurseShift['department'] }}</small>
            </div>
        ...
        <div class="card-modern p-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h6 class="font-weight-bold text-dark mb-0"><i class="fas fa-heartbeat text-danger mr-2"></i>
                    បញ្ជីអ្នកជំងឺត្រៀមវាស់សញ្ញាជីវិត (Triage Queue)</h6>
                <span class="badge badge-danger px-3 py-1 font-weight-bold">{{ $pendingVitalsCount ?? 0 }} Pending
                    Vitals</span>
            </div>
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        @forelse($triageQueue as $rec)
                            <tr>
                                <td><span
                                        class="badge badge-light border font-weight-bold">{{ $rec->patient->patient_code ?? 'N/A' }}</span>
                                </td>
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-sm btn-outline-danger font-weight-bold"
                                        data-toggle="modal" data-target="#nurseVitalsModal{{ $rec->record_id }}">
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content border-0 rounded-lg">
                                        <form action="{{ route('doctor.vitals.update') }}" method="POST">
                                            ...
                                            <div class="modal-header bg-danger text-white">
                                                <h5 class="modal-title font-weight-bold">បញ្ចូលសញ្ញាជីវិតសម្រាប់:
                                            ...
                                            <div class="modal-body p-4 text-left">
                                                <div class="row">
                                                    <div class="col-6 form-group">
                                                        ...
                                                        <input type="text" name="blood_pressure" class="form-control"
                                                            value="{{ $rec->blood_pressure }}" placeholder="120/80">
                                                    </div>
                                                    <div class="col-6 form-group">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    data-dismiss="modal">បោះបង់</button>
                                                <button type="submit" class="btn btn-danger font-weight-bold"><i
                                                        class="fas fa-save mr-1"></i> រក្សាទុក Vitals</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
